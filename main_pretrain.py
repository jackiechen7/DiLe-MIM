...
from model import models_dconv_mask_mae, models_convmae, models_mae, models_dmae

from engine_pretrain import train_one_epoch, evaluate_pretrain
from engine_pretrain_single import train_one_epoch_corrupt, evaluate_pretrain_corrupt
# from util.dataset_us import CorruptDataset

from util.dataset_single import CorruptDataset
def get_args_parser():
    ...
    parser.add_argument('--data_path_mask', default='', type=str,
                        help='original dataset path')
...
def main(args):
    ...
    # Deblurring MAE or ConvMAE
        ...
        dataset_train = CorruptDataset(args.data_path_blurred, args.data_path_orig, args.data_path_mask,args.input_size, is_train=True)
        dataset_val = CorruptDataset(args.data_path_blurred, args.data_path_orig, args.data_path_mask,args.input_size, is_train=False)
    ...
    if args.model in [ "mae_vit_base_patch16", "mae_vit_large_patch16", "mae_vit_huge_patch16" ]:
        ...
        model = models_dconv_mask_mae.__dict__[args.model](norm_pix_loss=args.norm_pix_loss)
    model.to(device)
